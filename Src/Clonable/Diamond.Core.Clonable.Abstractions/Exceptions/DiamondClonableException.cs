...
namespace Diamond.Core.Clonable
{
	...
	public abstract class DiamondClonableException : DiamondCoreException
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DiamondClonableException"/> class with serialized data.
		/// </summary>
		...
		protected DiamondClonableException(SerializationInfo info, StreamingContext context)
		: base(info, context)
		{
		}
	}
