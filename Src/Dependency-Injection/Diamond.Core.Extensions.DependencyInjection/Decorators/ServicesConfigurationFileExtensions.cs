...
namespace Diamond.Core.Extensions.DependencyInjection
{
	...
	/// </summary>
	public static class ServicesConfigurationFileExtensions
	{
		/// <summary>
		...
		/// <param name="filePath">The relative or absolute path to the configuration folder.</param>
		/// <returns>The <see cref="IConfigurationBuilder"/> with the added configuration folder.</returns>
		public static IConfigurationBuilder AddServicesConfigurationFile(this IConfigurationBuilder builder, string filePath)
		{
			return AddServicesConfigurationFile(builder, provider: null, filePath: filePath, optional: false, reloadOnChange: false);
		}
		...
		/// reloading.</remarks>
		/// <param name="builder">The <see cref="IConfigurationBuilder"/> to which the configuration folder will be added.</param>
		/// <param name="filePath">The path to the folder containing the configuration files. This path can be relative or absolute.</param>
		...
		/// <returns>The <see cref="IConfigurationBuilder"/> with the added configuration folder.</returns>
		public static IConfigurationBuilder AddServicesConfigurationFile(this IConfigurationBuilder builder, string filePath, bool optional)
		{
			return AddServicesConfigurationFile(builder, provider: null, filePath: filePath, optional: optional, reloadOnChange: false);
		}
		...
		/// <returns>The <see cref="IConfigurationBuilder"/> with the added configuration folder.</returns>
		public static IConfigurationBuilder AddServicesConfigurationFile(this IConfigurationBuilder builder, string filePath, bool optional, bool reloadOnChange)
		{
			return AddServicesConfigurationFile(builder, provider: null, filePath: filePath, optional: optional, reloadOnChange: reloadOnChange);
		}
		...
		/// <param name="filePath">The relative path to the configuration folder. Cannot be <see langword="null"/> or whitespace.</param>
		...
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="builder"/> is <see langword="null"/> or if <paramref name="filePath"/> is <see
		/// langword="null"/> or whitespace.</exception>
		public static IConfigurationBuilder AddServicesConfigurationFile(this IConfigurationBuilder builder, IFileProvider provider, string filePath, bool optional, bool reloadOnChange)
		{
			...
			return builder.AddServicesConfigurationFile(s =>
			{
		...
		/// <param name="configureSource">An <see cref="Action{T}"/> delegate used to configure the <see cref="ServicesConfigurationFileSource"/>.</param>
		/// <returns>The <see cref="IConfigurationBuilder"/> with the added configuration source.</returns>
		public static IConfigurationBuilder AddServicesConfigurationFile(this IConfigurationBuilder builder, Action<ServicesConfigurationFileSource> configureSource) => builder.Add(configureSource);
	}
}
