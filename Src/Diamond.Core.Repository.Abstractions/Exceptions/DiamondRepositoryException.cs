...
namespace Diamond.Core.Repository
{
	...
	public class DiamondRepositoryException : DiamondCoreException
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DiamondRepositoryException"/> class with a specified error message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DiamondRepositoryException"/> class with a specified error
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DiamondRepositoryException"/> class with serialized data.
		/// </summary>
